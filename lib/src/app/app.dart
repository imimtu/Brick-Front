...
class App extends StatelessWidget {
  ...
  final GoRouter _router = GoRouter(
        ...
        pageBuilder: (context, state) {
          return CustomTransitionPage(
            ...
            transitionsBuilder: (
              ...
              return Dismissible(key: UniqueKey(), child: child);
            },
          );
        },
      ),
    ...
    redirect: (context, state) {
      ...
      bool toAuth = state.location.contains("/auth"); // 회원 가입 / 로그인 화면으로의 이동 여부
      bool toSplash = state.location == Splash.path; // Splash 화면으로의 이동 여부
